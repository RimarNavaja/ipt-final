...
export class AddEditComponent implements OnInit {
  ...
  constructor(
    ...
    // Set minimum date to today's date in ISO format (YYYY-MM-DD)
  ...
  ngOnInit() {
    ...
    forkJoin({
      ...
      if (this.id && results.employee) {
        ...
        // Set default hire date to current date for new employees
        if (!this.employee.hireDate) {
          this.employee.hireDate = this.minDate;
        }
      }
